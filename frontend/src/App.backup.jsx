...
function App() {
  ...
  const handleAnalystAction = (transactionId, action) => {
      ...
      <main className="dashboard">
        ...
        <section className="content-grid">
          ...
          <InvestigationPanel
            ...
            analystAction={
              selectedTransaction
                ? analystActions[selectedTransaction.id]
                : null
            }
...
function RiskBadge({ level }) {
  ...
  return (
    <span
      className={`risk-badge ${safeLevel.toLowerCase()}`}
    >
      {safeLevel}
    </span>
  );
    ...
    return (
      <div className="panel investigation-panel">
        <div className="empty-investigation">
          ...
          <p>
            Select a transaction from the live feed to
            investigate it.
          </p>
        </div>
      </div>
